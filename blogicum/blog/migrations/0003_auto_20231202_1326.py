# Generated by Django 3.2.16 on 2023-12-02 10:26
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('blog', '0002_rename_pup_date_post_pub_date'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='category',
            options={'verbose_name': 'обьект "категория"', 'verbose_name_plural': 'Категории'},
        ),
        migrations.AlterModelOptions(
            name='location',
        ...
        migrations.AlterModelOptions(
            name='post',
            options={'verbose_name': 'обьект "публикация"', 'verbose_name_plural': 'Публикации'},
        ),
